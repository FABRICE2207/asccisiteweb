  ...
  <div className="space-y-4">
    ...
    <div className="mt-15">
      ...
      <p className="text-[18px] text-[#000080] mt-5">
       Dans les années 1950, le scoutisme catholique a commencé à se structurer 
      davantage, avec la création de groupes scouts au sein des paroisses. Ces groupes avaient pour objectif de former les jeunes non seulement sur le 
      plan spirituel, mais aussi sur le plan moral et social, en leur 
