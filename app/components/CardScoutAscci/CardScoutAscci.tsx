...
import MouvementScout from "../ScoutAscci/MouvementScout";
import ProjetPedagogique from "../ScoutAscci/ProjetPedagogique";
import MethodeScoute from "../ScoutAscci/MethodeScoute";
import PromesseLoiScoutes from "../ScoutAscci/PromesseLoiScoutes";
import HistoireScoutisme from "../ScoutAscci/HistoireScoutisme";
import Formation from "../ScoutAscci/Formation";

const CONTENT_COMPONENTS = {
  "Le-Mouvement-Scout": MouvementScout,
  "Projet-pédagogique": ProjetPedagogique,
  "Méthode-scoute": MethodeScoute,
