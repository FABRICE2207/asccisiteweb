...
import Region from "../TrouvezNous/Region";
import District from "../TrouvezNous/District";
import Groupe from "../TrouvezNous/Groupe";
import DansMonde from "../TrouvezNous/DansMonde";

const CONTENT_COMPONENTS = {
  "Région": Region,
  "District": District,
  "Groupe": Groupe,
  "Dans-le-monde": DansMonde
};

const CardTrouvezNous =() => {
...
export default CardTrouvezNous;
